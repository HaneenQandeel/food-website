    ...
    return ( 
        <div className="max-w-[1640px] m-auto px-4 py-12">
                ...
                <div className="flex flex-col lg:flex-row justify-between mt-5">
                    <div>
                        <p className="font-bold text-gray-700 text-start">Filter type</p>
                        <div className="flex justfiy-between flex-wrap mt-[10px]">
                            ...
                            <button className="m-1 text-orange-500 font-semibold border py-2  px-4 border-orange-400 rounded-full shadow">Chicken</button>
                        </div>
                    </div>
                    <div>
                        <p className="font-bold text-gray-700 text-start">Filter type</p>
                        <div className="flex justfiy-between flex-wrap mt-[10px]">
                            <button className=" text-orange-500 font-semibold py-1 px-6 border border-orange-400 rounded-full
                            shadow">$</button>
                            <button className="m-1 text-orange-500 font-semibold border py-2 px-4 border-orange-400 rounded-full shadow">$$</button>
                            <button className="m-1 text-orange-500 font-semibold border py-2 px-4 border-orange-400 rounded-full shadow">$$$</button>
                            <button className="m-1 text-orange-500 font-semibold border py-2  px-4 border-orange-400 rounded-full shadow">$$$$</button>
                        </div>
                    </div>
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-7 pt-4 ">
                { data.map((item) => (
